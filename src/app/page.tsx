  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <nav className="w-full flex items-center justify-between p-4 bg-white shadow-md fixed top-0 z-50">
        <a className="text-xl font-bold nav-left" href="#">
          IT
        </a>
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2">
          <span>
            <Image
              src="/icons/location-pin-svgrepo-com1.svg"
              alt="location"
              width={15}
              height={15}
              className="inline"
        ...
        <div className="hidden md:flex items-center space-x-8 relative nav-right">
          ...
          <a href="#" className="text-red-500 relative">
            Login
            <span className="absolute left-0 w-full h-[2px] bg-red-500 top-[45px]"></span>
          </a>
          <button className="bg-red-500 text-white px-4 py-2 rounded-lg shopper-btn">
            Become a Shopper
          </button>
        </div>
        ...
        <div className="md:hidden flex items-center space-x-4">
          <div className="user-circle">
            <Image
              src="/icons/user-circle-svgrepo-com1.svg"
              alt="User"
              width={30}
              height={30}
            />
        ...
        {/* Mobile Menu */}
        <div
          className={`fixed top-0 right-0 w-[250px] h-full bg-white shadow-md transform ${
              ...
              <>
                <div className="content-wrapper">
                  <div className="call-to-action">
                    <h2 className="text-lg font-semibold font-[sans-serif]">
                      Welcome back
                    </h2>
                  </div>
                  <p className="text-sm text-gray-500 m-lg">Login using:</p>
                  <br />
                  <button className="flex items-center justify-center w-full mt-4 border p-2 rounded-lg-btn-google shadow-md">
                    <Image
                      src="/icons/google-logo-search-new-svgrepo-com1.svg"
                      alt="Google"
                      width="26"
                      height="26"
                    />
                  ...
                  <p
                    className="mt-4 text-sm text-gray-500 cursor-pointer flex items-left justify-left"
                    onClick={() => setIsManual(true)}
                  >
                    <span className="inline-block">
                      <Image
                        src="/icons/switch-horizontal-svgrepo-com1.svg"
                        alt="Switch"
                        width="20"
                        height="20"
                      />
              ...
              <>
                ...
                <div className="login-content">
                  <input
                    ...
                    className="w-[100%] mt-2 p-2 border rounded-md login-content-input"
                  />
                  <input
                    type="password"
                ...
                <button className="w-[40%] bg-black text-white p-2 mt-4 rounded-lg proceed-btn">
                  Proceed
                </button>
                <p
                  className="mt-4 text-sm text-gray-500 cursor-pointer flex items-left justify-left"
